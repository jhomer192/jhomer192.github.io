...
function Swatch({ hex, label }: { hex: string; label: string }) {
  ...
  return (
    ...
    >
      ...
      />
      <span className="text-xs text-text-muted font-mono">{copied ? 'Copied!' : hex}</span>
  ...
  return (
    <div className="mb-16">
      <div className="rounded-2xl border border-border bg-surface p-6 md:p-8">
        ...
        {/* Palette swatches */}
        <div className="mb-8">
          <p className="text-xs text-text-muted mb-3 font-medium">Extracted palette (click to copy)</p>
        ...
        {/* Mockup preview */}
        <div className="rounded-xl overflow-hidden border border-border mb-6" style={previewStyle}>
          {/* Hero */}
          <div
